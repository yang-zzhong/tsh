...
func TestChainedError(t *testing.T) {
	...
	em := "ERROR: \"hello world again\" in git.woa.com/oliverzyang/tsh/errors.TestChainedError\n\tCaused by\n\t  \"ios report error\" in git.woa.com/oliverzyang/tsh/errors.TestChainedError\n\tCaused by\n\t  \"http post message error\" in git.woa.com/oliverzyang/tsh/errors.TestChainedError\n\tCaused by\n\t  \"send message error\" in git.woa.com/oliverzyang/tsh/errors.TestChainedError\n\tCaused by\n\t  \"connection reset by peer\" in git.woa.com/oliverzyang/tsh/errors.TestChainedError\n"
...
func TestNestedChainedError(t *testing.T) {
	...
	em := "ERROR: \"chained error 2\" in git.woa.com/oliverzyang/tsh/errors.testNCE1\n\tCaused by\n\t  \"chained error 3\" in git.woa.com/oliverzyang/tsh/errors.testNCE2\n\tCaused by\n\t  \"chained error 4\" in git.woa.com/oliverzyang/tsh/errors.testNCE3\n\tCaused by\n\t  \"hello world\" in git.woa.com/oliverzyang/tsh/errors.TestNestedChainedError\n"
	if em != err.String() {
